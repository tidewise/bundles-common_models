...
module Rock
    module Base
        ...
        class ControlLoop < Syskit::Composition
            ...
            #    The first one is providing Rock::Base::ControllerSrv and the second one is
            #    providing Rock::Base::ControlledSystemSrv
            ...
            #       provides Rock::Base::ControllerSrv
            #       output_port 'command_out'
            #       input_port 'status_in'
            #   end
            #   data_service_type "ControlledSystem" do
            #       provides Rock::Base::ControlledSystemSrv
            #       input_port 'command_in'
            #       output_port 'status_out'
            #   end
            #   ControlLooop.specialize Rock::Base::ControlledSystemSrv do
            ...
            #   end
            #   ControlLooop.specialize Rock::Base::ControllerSrv do
            #   end
            #
            def self.declare(name, control_type, options = Hash.new)
                ...
                controller_model = Rock::Base.data_service_type "#{name}ControllerSrv" do
                    provides Rock::Base::ControllerSrv
                ...
                controlled_system_model = Rock::Base.data_service_type "#{name}ControlledSystemSrv" do
                    provides Rock::Base::ControlledSystemSrv
